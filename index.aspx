...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="tp-slider-5__active tp-breadcrumb__area fix tp-breadcrumb-height" style="position: relative; overflow: hidden; padding-top: 0px; padding-bottom: 0px;">
        <div class="swiper-wrapper">
            <div class="swiper-slide" style="position: relative;">
                <img src="uploads/slider/slider-01.jpg" alt="Slide 1" style="object-fit: cover;">
                <%--  <div style="position: absolute; top: 50%; left: 10%; transform: translateY(-50%); color: #fff; max-width: 500px;">
                    <span style="display: block; font-size: 16px; font-weight: 500; margin-bottom: 10px;">100% Best Product</span>
                    <h3 style="font-size: 48px; font-weight: 700; line-height: 1.2; margin: 0 0 20px 0;">New <span style="color: #FF8617;">Brochure</span> Digital Print</h3>
                    <p style="margin: 0 0 15px 0; font-size: 18px;">Custom Brochure Printing</p>
                    <span style="font-size: 22px;">$180.99 / <del>$286.00</del></span><br>
                    <br>
                    <a href="shop-details.html" style="display: inline-block; background: #fff; color: #000; padding: 12px 25px; font-weight: 600; text-decoration: none; border-radius: 5px;">Buy Now
                    </a>
                </div>--%>
            </div>
            <div class="swiper-slide" style="position: relative;">
                <img src="uploads/slider/slider-02.jpg" alt="Slide 2" style="object-fit: cover;">
                <%--<div style="position: absolute; top: 50%; left: 10%; transform: translateY(-50%); color: #fff; max-width: 500px;">
                    <span style="display: block; font-size: 16px; font-weight: 500; margin-bottom: 10px;">Trending Product
                    </span>
                    <h3 style="font-size: 48px; font-weight: 700; line-height: 1.2; margin: 0 0 20px 0;">Modern <span style="color: #FF8617;">Catalog</span> Print
                    </h3>
                    <p style="margin: 0 0 15px 0; font-size: 18px;">Premium quality catalog printing</p>
                    <span style="font-size: 22px;">$120.50 / <del>$200.00</del></span><br>
                    <br>
                    <a href="shop-details.html"
                        style="display: inline-block; background: #fff; color: #000; padding: 12px 25px; font-weight: 600; text-decoration: none; border-radius: 5px;">Buy Now
                    </a>
                </div>--%>
            </div>
            <div class="swiper-slide" style="position: relative;">
                <img src="uploads/slider/slider-03.jpg" alt="Slide 2" style="object-fit: cover;">
                <%--<div style="position: absolute; top: 50%; left: 10%; transform: translateY(-50%); color: #fff; max-width: 500px;">
         <span style="display: block; font-size: 16px; font-weight: 500; margin-bottom: 10px;">Trending Product
         </span>
         <h3 style="font-size: 48px; font-weight: 700; line-height: 1.2; margin: 0 0 20px 0;">Modern <span style="color: #FF8617;">Catalog</span> Print
        ...
        <div class="swiper-pagination"
            style="position: absolute; bottom: 20px; left: 0; right: 0; text-align: center; z-index: 99;">
        </div>

        <!-- Custom Arrows (match your JS config) -->
        <div class="test-prev"
            style="position: absolute; top: 50%; right: 20px; transform: translateY(-50%); color: #fff; font-size: 40px; cursor: pointer; z-index: 99;">
            ›
        </div>
        <div class="test-next"
            style="position: absolute; top: 50%; left: 20px; transform: translateY(-50%); color: #fff; font-size: 40px; cursor: pointer; z-index: 99;">
            ‹
        </div>
    </div>
                ...
                <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".5s">
                    <div class="tp-about__item-wrap">
                        <div class="tp-about__section-box">
                            ...
                            <p>
                                Turn digital images into physical products with
                                    Printes – print locally, scale globally.
                            </p>
                        </div>
                        <div
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-catagori__section-box text-center pb-55">
                        ...
                        <h3 class="tp-section-title">Explore all <span class="p-relative">catagories
                                    <span class="tp-title-shape">
            ...
            <div class="col-xl-12">
                <div class="tp-catagori__button text-center mt-70">
                    <a class="tp-btn-gradiant" href="contact.html">Let’s talk — Send a message
                            <i>
                                        ...
                                        <div class="tp-service__bottom-box">
                                            ...
                                            <div class="tp-service__content">
                                                <h4 class="tp-service__title p-relative">
                                                    <a href="service-details.html">Custom Print Design
                                                       <%-- <span class="tp-title-shape">                                                            
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-service__item fix p-relative">
                                        ...
                                        <div class="tp-service__bottom-box">
                                            ...
                                            <div class="tp-service__content">
                                                <h4 class="tp-service__title p-relative">
                                                    <a href="service-details.html">Holographic Stickers
                                                        <%--<span class="tp-title-shape">
                                                            <svg width="219" height="2" viewBox="0 0 219 2"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-service__item fix p-relative">
                                        ...
                                        <div class="tp-service__bottom-box">
                                            ...
                                            <div class="tp-service__content">
                                                <h4 class="tp-service__title p-relative">
                                                    <a href="service-details.html">Waterproof Labels
                                                       <%-- <span class="tp-title-shape">
                                                            <svg width="219" height="2" viewBox="0 0 219 2"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-service__item fix p-relative">
                                        ...
                                        <div class="tp-service__bottom-box">
                                            ...
                                            <div class="tp-service__content">
                                                <h4 class="tp-service__title p-relative">
                                                    <a href="service-details.html">Custom T-Shirt Design
                                                        <%--<span class="tp-title-shape">
                                                            <svg width="219" height="2" viewBox="0 0 219 2"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="tp-business__section-box pb-45 text-center">
                            ...
                            <h3 class="tp-section-title">VistaPrint: Here for small
                                <br>
                    ...
                    <div class="row row-cols-xl-5 row-cols-lg-5 row-cols-md-3 row-cols-sm-3 row-cols-2">
                        <div class="col mb-30">
                            <div class="tp-business__item text-center">
                                ...
                                <h5 class="tp-business__title">Eco-friendly Local
                                    <br>
                                    Products</h5>
                            </div>
                        </div>
                        <div class="col mb-30">
                            <div class="tp-business__item text-center">
                                ...
                                <h5 class="tp-business__title">500,00+ customisable
                                    <br>
                                    products</h5>
                            </div>
                        </div>
                        <div class="col mb-30">
                            <div class="tp-business__item text-center">
                                ...
                                <h5 class="tp-business__title">Starting from 100
                                    <br>
                                    Boxes</h5>
                            </div>
                        </div>
                        <div class="col mb-30">
                            <div class="tp-business__item text-center">
                                ...
                                <h5 class="tp-business__title">Custom brand tools
                                    <br>
                                    for print</h5>
                            </div>
                        </div>
                        <div class="col mb-30">
                            <div class="tp-business__item text-center">
                                ...
                                <h5 class="tp-business__title">Exclusive team
                                    <br>
                                    members</h5>
                            </div>
                        </div>
                                    ...
                                    <div class="tp-business__content d-flex align-items-start">
                                        ...
                                        <div class="tp-business__content-text">
                                            <h5 class="tp-business__content-title">First of all have to Add your
                                                    shirt design</h5>
                                            <p>
                                                Lorem ipsum det, cowec tetur duis nec fringi
                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="tp-testimonial__left-box z-index">
                        ...
                        <div class="tp-testimonial__button">
                            <p>
                                Beautiful, customizable template, with a ton of
                                    blocks to create an amazing website that
                            </p>
            ...
            <div class="row">
                    ...
                    <div class="tp-blog__item">
                        <div class="tp-blog__thumb">
                            <a href="blog-details.html">
                                <img class="w-100" src="assets/img/blog/blog1-1.jpg" alt=""></a>
                        ...
                        <div class="tp-blog__content">
                            ...
                            <h5 class="tp-blog__title"><a href="blog-details.html">How Chatbots Can Help You
                                <br>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30 wow tpfadeUp" data-wow-duration=".9s"
                    ...
                    <div class="tp-blog__item">
                        <div class="tp-blog__thumb">
                            <a href="blog-details.html">
                                <img class="w-100" src="assets/img/blog/blog1-2.jpg" alt=""></a>
                            <div class="tp-blog__thumb-text">
                                <span>12
                                    <br>
                                    <b>Feb</b></span>
                        ...
                        <div class="tp-blog__content">
                            ...
                            <h5 class="tp-blog__title"><a href="blog-details.html">Emergency printing press
                                <br>
                                near you?</a></h5>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30 wow tpfadeUp" data-wow-duration=".9s"
                    ...
                    <div class="tp-blog__item">
                        <div class="tp-blog__thumb">
                            <a href="blog-details.html">
                                <img class="w-100" src="assets/img/blog/blog1-3.jpg" alt=""></a>
                            <div class="tp-blog__thumb-text">
                                <span>09<br>
                                    <b>Jan</b></span>
                            </div>
                        ...
                        <div class="tp-blog__content">
                            ...
                            <h5 class="tp-blog__title"><a href="blog-details.html">Introduction to our way of
                                <br>
                                work near you.</a></h5>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="tp-cta__content text-center">
                            <h3 class="tp-cta__title">Ready to create some
                                <br>
